...
func getTwitchClip(statusCode int, v5API *gotwitch.TwitchAPI, clipSlug string) func() (interface{}, error) {
	return func() (interface{}, error) {
		...
		return &LinkResolverResponse{
			Status:  statusCode,
			Tooltip: "<div style=\"text-align: left;\"><b>" + clip.Title + "</b><hr><b>Channel:</b> " + clip.Broadcaster.DisplayName + "<br><b>Views:</b> " + insertCommas(strconv.FormatInt(int64(clip.Views), 10), 3) + "</div>",
		}, nil
	}
}
